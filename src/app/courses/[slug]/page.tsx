  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-16 sm:px-6">
        ...
        <div>
          ...
          <dl className="mt-8 grid gap-4 sm:grid-cols-2">
            <div className="rounded-[1.5rem] border border-white/10 bg-white/[0.03] p-4">
              <dt className="text-xs uppercase tracking-[0.2em] text-white/42">適合對象</dt>
              <dd className="mt-2 text-sm leading-7 text-white/76">{course.audience}</dd>
            </div>
            <div className="rounded-[1.5rem] border border-white/10 bg-white/[0.03] p-4">
              <dt className="text-xs uppercase tracking-[0.2em] text-white/42">上課地點</dt>
              <dd className="mt-2 text-sm leading-7 text-white/76">{course.location}</dd>
            </div>
            <div className="rounded-[1.5rem] border border-white/10 bg-white/[0.03] p-4">
              <dt className="text-xs uppercase tracking-[0.2em] text-white/42">課程長度</dt>
              <dd className="mt-2 text-sm leading-7 text-white/76">{course.duration}</dd>
            </div>
            <div className="rounded-[1.5rem] border border-white/10 bg-white/[0.03] p-4">
              <dt className="text-xs uppercase tracking-[0.2em] text-white/42">難度</dt>
              <dd className="mt-2 text-sm leading-7 text-white/76">{course.difficulty}</dd>
            </div>
          </dl>
        </div>
      ...
      <section className="mt-12 grid gap-6 lg:grid-cols-3">
        <article className="rounded-[2rem] border border-white/10 bg-white/[0.03] p-6 lg:col-span-2">
          <h2 className="text-2xl font-black text-white">學習目標</h2>
          ...
          <h2 className="mt-8 text-2xl font-black text-white">課程內容</h2>
          <ul className="mt-4 space-y-3 text-sm leading-7 text-white/72">
          ...
          <h2 className="mt-8 text-2xl font-black text-white">教練建議</h2>
          <ul className="mt-4 space-y-3 text-sm leading-7 text-white/72">
          ...
          <h2 className="mt-8 text-2xl font-black text-white">注意事項</h2>
          <ul className="mt-4 space-y-3 text-sm leading-7 text-white/72">
        ...
        <aside className="rounded-[2rem] border border-white/10 bg-white/[0.03] p-6">
          <h2 className="text-2xl font-black text-white">課程諮詢方式</h2>
          ...
          <div className="mt-6 grid gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center rounded-full bg-[var(--accent)] px-5 py-3 text-sm font-bold text-black"
            >
              {course.lineCtaLabel}
            </a>
            <a
      ...
      <section className="mt-12">
        <h2 className="text-3xl font-black text-white">常見問題</h2>
        <div className="mt-6">
