    ...
    <main className="mx-auto max-w-7xl px-4 py-16 sm:px-6">
      ...
      <section className="mt-8 grid gap-6 lg:grid-cols-3">
        <article className="rounded-[2rem] border border-white/10 bg-white/[0.03] p-6 lg:col-span-2">
          <h2 className="text-2xl font-black text-white">品牌故事</h2>
        ...
        <article className="rounded-[2rem] border border-[#d7ff3f]/18 bg-[#d7ff3f]/8 p-6">
          <h2 className="text-2xl font-black text-white">教學理念</h2>
      ...
      <section className="mt-12 grid gap-6 lg:grid-cols-2">
        <article className="rounded-[2rem] border border-white/10 bg-white/[0.03] p-6">
          <h2 className="text-2xl font-black text-white">適合誰</h2>
          <ul className="mt-4 space-y-3 text-sm leading-7 text-white/72">
        ...
        <article className="rounded-[2rem] border border-white/10 bg-white/[0.03] p-6">
          <h2 className="text-2xl font-black text-white">安全重點</h2>
          <ul className="mt-4 space-y-3 text-sm leading-7 text-white/72">
            <li>• 先做護具與暖身確認</li>
            <li>• 用動作拆解降低初學壓力</li>
            <li>• 先穩再快，先理解再追求技巧</li>
